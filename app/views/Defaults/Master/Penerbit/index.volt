{% extends 'template/dashboard.volt' %} {% block title %}Master - Data
Penerbit{% endblock %} {% block content %}
<style>
...
<div class="page-content">
  <div class="card ccard mx-auto" style="width: 98%; position: sticky">
    <div
      ...
      "
    >
      <h4 class="card-title text-dark-m3 mt-2">Master - Data Penerbit</h4>
    ...
    <div class="modal-content radius-4">
      <div class="modal-header bgc-primary radius-t-4">
        <h4 class="modal-title text-white">
          <i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Penerbit
        </h4>
...
<script>
  {% include 'Defaults/Master/Penerbit/index.js' %}
</script>
{% endblock %}
