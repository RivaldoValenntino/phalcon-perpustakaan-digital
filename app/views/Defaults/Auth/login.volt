{% extends 'template/auth.volt' %} {% block title %} Login -
{{ config.appName }}
{% endblock %} {% block inline_style %}
<style>
  .body-container {
    background: linear-gradient(to right, #0e0e0ecc, #0e0e0ecc),
      url("{{ url('assets') }}/image/bg-library2.jpg");
    ...
    <div class="col-6 offset-3 bgc-white shadow radius-1 overflow-hidden py-5">
      <div class="mh-100">
        <div class="row justify-content-center">
          <div class="col-12 mt-2">
            <img
              ...
              src="{{ url('assets') }}/image/kepeg.png"
        ...
        <div class="d-none d-lg-block col-md-6 offset-md-3 mt-lg-4 px-0">
          ...
          <div
            class="alert d-flex bgc-red-l3 brc-success-m4 border-0 p-0"
            role="alert"
          >
          ...
          >
            ...
            <span class="ml-3 align-self-center text-dark-tp3">
              Akun anda tidak diijinkan untuk akses sistem ini
            </span>
          </div>
      ...
      <form autocomplete="off" class="form-row mt-4" method="post">
        ...
        >
          ...
          >
            ...
            <label
              class="floating-label text-grey-l1 ml-n3"
        ...
        >
          <div
            class="d-flex align-items-center input-floating-label text-blue brc-blue-m2"
          >
            <input name="tahun" placeholder="Tahun" type="text"
            class="form-control form-control-lg pr-4 shadow-none yearpicker"
            id="id-login-tahun" value="<?= date("Y")+1 ?>"/>
