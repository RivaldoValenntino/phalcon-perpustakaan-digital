{% extends 'template/dashboard.volt' %} {% block title %} Transaksi -
Pengembalian {% endblock %} {% block content %}
<style>
...
<div class="page-content">
  <div class="card ccard mx-auto" style="width: 98%; position: sticky">
    <div
      ...
      "
    >
      <h4 class="card-title text-dark-m3 mt-2">Transaksi - Pengembalian</h4>
            ...
            >
              <thead>
                <tr class="bgc-info text-white text-left brc-black-tp10">
                  ...
                  <th style="vertical-align: left">No. Peminjaman</th>
                  <th style="vertical-align: left">Nama</th>
                  <th style="vertical-align: left">No.Telp</th>
                  <th style="vertical-align: left">Email</th>
                  <th style="vertical-align: left">Judul Buku</th>
                  <th style="vertical-align: left">Kode Buku</th>
                  <th style="vertical-align: left">Cover Buku</th>
                  <th style="vertical-align: left">Tgl. Peminjaman</th>
                  <th style="vertical-align: left">Tgl. Pengembalian</th>
                </tr>
              </thead>
...
<script>
  {% include 'Defaults/Pengembalian/index.js' %}
</script>
{% endblock %}
