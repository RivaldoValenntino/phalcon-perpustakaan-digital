{% extends 'template/dashboard.volt' %} {% block title %}Data Denda {% endblock
%} {% block content %}
<style>
...
<div class="page-content">
  <div class="card ccard mx-auto" style="width: 98%; position: sticky">
    <div
      ...
      "
    >
      <h4 class="card-title text-dark-m3 mt-2">Data Denda</h4>
            ...
            >
              <thead>
                <tr class="bgc-info text-white text-center brc-black-tp10">
                  ...
                  <th style="vertical-align: middle">Jumlah Denda</th>
                </tr>
              </thead>
              <tbody></tbody>
            </table>
    ...
    <div class="modal-content radius-4">
      <div class="modal-header bgc-primary radius-t-4">
        <h4 class="modal-title text-white">
          <i class="fa fa-list text-white"></i>&nbsp;&nbsp; Form - Denda
        </h4>
...
<script>
  {% include 'Defaults/Denda/index.js' %}
</script>
{% endblock %}
