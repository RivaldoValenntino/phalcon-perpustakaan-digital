...
<div class="page-content">
  <div class="card ccard mx-auto" style="width: 98%; position: sticky">
    <div
      ...
      "
    >
      <h4 class="card-title text-dark-m3 mt-2">Transaksi - Peminjaman</h4>
      <div class="page-tools mt-3 mt-sm-0 mb-sm-n1 card-toolbar">
        ...
        <a
          href="#"
          class="btn mr-1 btn-warning mb-2 radius-2"
          id="btn-kembalikan"
        >
          <i class="fa fa-undo text-110 align-text-bottom mr-2"></i>
          Pengembalian
        </a>
      </div>
    </div>
...
<script>
  {% include 'Defaults/Peminjaman/index.js' %}
</script>
{% endblock %}
